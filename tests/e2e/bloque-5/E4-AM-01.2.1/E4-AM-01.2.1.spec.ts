...
const uploadCase = VALID_AM_UPLOAD_CASES['E4-AM-01.2.1'];
test('@bloque5 @E4-AM-01.2.1 @am @upload_valido @gestor-asiento @regression reemplaza archivo Partidas', async ({ page }) => {
  ...
  await test.step('Validar Subir un nuevo archivo y procesar Partidas', async () => {
