...
const uploadCase = AM_DATA_UPLOAD_CASES['E8-AM-02.1'];
test('@bloque5 @E8-AM-02.1 @am @upload_incompleto @gestor-asiento @critical rechaza datos incompletos en Exactus', async ({ page }) => {
  ...
  await test.step('Cargar Exactus con datos obligatorios incompletos', async () => { await runAmDataUpload(page, uploadCase); });
});
