...
const uploadCase = VALID_AM_UPLOAD_CASES['E4-AM-02.3'];
test.use({ storageState: '.auth/gestorAM.json' });

test('@bloque5 @E4-AM-02.3 @am @upload_valido @gestor-asiento @critical carga Unidad de Cuenta AM', async ({ page }) => {
  ...
  await test.step('Cargar archivo REAL Unidad de Cuenta AM', async () => {
