...
const uploadCase = VALID_AM_UPLOAD_CASES['E4-AM-01.3'];
test.use({ storageState: '.auth/gestorAM.json' });

test('@bloque5 @E4-AM-01.3 @am @upload_valido @gestor-asiento @critical carga Centros', async ({ page }) => {
  ...
  await test.step('Cargar archivo REAL Centros AM', async () => {
