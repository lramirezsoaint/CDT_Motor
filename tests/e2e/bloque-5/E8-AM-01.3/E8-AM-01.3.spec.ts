...
const uploadCase = AM_DATA_UPLOAD_CASES['E8-AM-01.3'];
test('@bloque5 @E8-AM-01.3 @am @upload_incompleto @gestor-asiento @critical rechaza datos incompletos en Centros', async ({ page }) => {
  ...
  await test.step('Cargar Centros con datos obligatorios incompletos', async () => { await runAmDataUpload(page, uploadCase); });
});
