...
export const AM_QUERY_CASES: Record<string, AmQueryCase> = Object.fromEntries([
  ...
  column('E60-AM-01.1.1', 'columnSelect', 'Parametrización', 'Cuentas Contables'),
  column('E60-AM-01.1.2', 'columnSelect', 'Parametrización', 'Centros'),
  column('E60-AM-01.2.1', 'columnSelect', 'Aprovisionamiento', 'Exactus'),
  column('E60-AM-01.2.2', 'columnSelect', 'Aprovisionamiento', 'Exactus', 'Exactus procesado'),
  column('E60-AM-02.1.1', 'columnSearch', 'Parametrización', 'Cuentas Contables'),
  column('E60-AM-02.1.2', 'columnSearch', 'Parametrización', 'Centros'),
  column('E60-AM-02.2.1', 'columnSearch', 'Aprovisionamiento', 'Exactus'),
  column('E60-AM-02.2.2', 'columnSearch', 'Aprovisionamiento', 'Exactus', 'Exactus procesado'),
  column('E60-AM-03.1.1', 'showAll', 'Parametrización', 'Cuentas Contables'),
  column('E60-AM-03.1.2', 'showAll', 'Parametrización', 'Centros'),
  column('E60-AM-03.2.1', 'showAll', 'Aprovisionamiento', 'Exactus'),
  column('E60-AM-03.2.2', 'showAll', 'Aprovisionamiento', 'Exactus', 'Exactus procesado'),
  column('E60-AM-04.1.1', 'hideAll', 'Parametrización', 'Cuentas Contables'),
  column('E60-AM-04.1.2', 'hideAll', 'Parametrización', 'Centros'),
  column('E60-AM-04.2.1', 'hideAll', 'Aprovisionamiento', 'Exactus'),
