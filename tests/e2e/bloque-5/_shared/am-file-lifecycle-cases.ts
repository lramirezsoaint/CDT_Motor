...
export const AM_FILE_LIFECYCLE_CASES: Record<string, AmFileLifecycleCase> = Object.fromEntries([
  ...
  row('E59-AM-01.1', 'overwrite', 'Parametrización', 'Cuentas Contables', 'Cuentas Contables', 'REAL Cuentas Contables AM'),
  row('E59-AM-01.2', 'overwrite', 'Parametrización', 'Partidas', 'Partidas', 'REAL Partidas AM'),
  row('E59-AM-01.3', 'overwrite', 'Parametrización', 'Centros', 'Centros', 'REAL Centros AM'),
  ...
  row('E61-AM-01.1', 'maxSize', 'Parametrización', 'Cuentas Contables', 'Cuentas Contables', 'REAL Cuentas Contables AM mayor a 30 MB'),
  row('E61-AM-01.2', 'maxSize', 'Parametrización', 'Partidas', 'Partidas', 'REAL Partidas AM mayor a 30 MB'),
  row('E61-AM-01.3', 'maxSize', 'Parametrización', 'Centros', 'Centros', 'REAL Centros AM mayor a 30 MB'),
