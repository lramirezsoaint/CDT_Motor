...
const uploadCase = REJECTED_AM_UPLOAD_CASES['E5-AM-01.2'];
test('@bloque5 @E5-AM-01.2 @am @upload_invalido @gestor-asiento @critical rechaza cabeceras incorrectas en Partidas', async ({ page }) => {
  ...
  await test.step('Cargar archivo diferente en Parametrizacion > Partidas', async () => {
