...
const uploadCase = VALID_AM_UPLOAD_CASES['E4-AM-01.1'];
test.use({ storageState: '.auth/gestorAM.json' });

test('@bloque5 @E4-AM-01.1 @am @upload_valido @gestor-asiento @critical carga Cuentas Contables', async ({ page }) => {
  ...
  await test.step('Cargar archivo REAL Cuentas Contables AM', async () => {
