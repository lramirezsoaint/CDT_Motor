...
test.describe('@bloque3 @gf @columnas @E60-GF-02.2.5', () => {
  test('@critical @bloque3 @gf @E60-GF-02.2.5 debe validar buscador de columnas en Maestro de Negocio Embebidos', async ({
