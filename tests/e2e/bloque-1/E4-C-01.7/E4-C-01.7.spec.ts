...
import scenarioData from '@data/bloque-1/E4-C-01.7.json';
import {
 acceptButtonFrom,
 goToComunesView,
 openUploadDialog,
...
test.describe('@bloque1 @E4-C-01.7 ', () => {
 test('@bloque1 @E4-C-01.7 @upload_valido debe aceptar un archivo valido de Configuracion de Parches y completar el flujo del modal', async ({
 page,
 }) => {
 test.setTimeout(240_000);

 await test.step('QA: ingresar a Distribucion y abrir Comunes > Configuracion de Parches', async () => {
 await goToComunesView(page, 'Configuracion de Parches', 'comunes/configuracion-parches');
 });
 ...
 fixtureDir: 'fixtures/files/bloque-1/E4-C-01.7',
 ...
 await validateSuccessfulUpload(page, { entityName: 'Configuracion de Parches', timeoutMs: 240_000 });
 });
 });
});
