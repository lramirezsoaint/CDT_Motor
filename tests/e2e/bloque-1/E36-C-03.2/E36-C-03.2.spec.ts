...
test.describe('@comunes @critical @E36-C-03.2', () => {
  test('@critical @comunes @E36-C-03.2 debe bloquear la edicion de Grupo Producto con errores especificos por campo', async ({
    page,
  }) => {
