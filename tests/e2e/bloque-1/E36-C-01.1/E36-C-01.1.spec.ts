...
test.describe('@comunes @critical @E36-C-01.1', () => {
  test('@critical @comunes @E36-C-01.1 debe editar la primera Línea usando solo los campos habilitados y capturar el resultado', async ({
    page,
  }) => {
