...
import scenarioData from '@data/bloque-1/E4-C-01.2.json';
import {
 acceptButtonFrom,
 goToComunesView,
 openUploadDialog,
...
test.describe('@bloque1 @E4-C-01.2 ', () => {
 test('@bloque1 @E4-C-01.2 @upload_valido debe aceptar un archivo valido de Grupo Producto y completar el flujo del modal', async ({
 page,
 }) => {
 ...
 fixtureDir: 'fixtures/files/bloque-1/E4-C-01.2',
 ...
 await validateSuccessfulUpload(page, { entityName: 'Grupo Producto', timeoutMs: 240_000 });
 });
 });
});
