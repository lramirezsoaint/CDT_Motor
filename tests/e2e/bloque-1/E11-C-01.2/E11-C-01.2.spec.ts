...
test.describe('@comunes @critical @E11-C-01.2', () => {
  test('@critical @comunes @E11-C-01.2 debe conservar estructura y datos en el archivo descargado de Grupo Producto', async ({ page }) => {
