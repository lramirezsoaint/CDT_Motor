...
test.describe('@bloque1 @E60-C-01.2 ', () => {
 test('@bloque1 @E60-C-01.2 @busqueda debe filtrar correctamente las columnas de Maestro UoA desde el buscador del modal', async ({
 page,
 }) => {
