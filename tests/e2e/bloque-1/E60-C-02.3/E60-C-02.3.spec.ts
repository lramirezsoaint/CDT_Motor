...
test.describe('@bloque1 @E60-C-02.3 ', () => {
 test('@bloque1 @E60-C-02.3 @columnas debe seleccionar todas las columnas disponibles en Unidades de Cuenta - BBA/VFA con "Mostrar todas"', async ({
 page,
 }) => {
