...
test.describe('@bloque1 @E60-C-01.3 ', () => {
 test('@bloque1 @E60-C-01.3 @columnas debe seleccionar todas las columnas disponibles en Maestro UoA con "Mostrar todas"', async ({
 page,
 }) => {
