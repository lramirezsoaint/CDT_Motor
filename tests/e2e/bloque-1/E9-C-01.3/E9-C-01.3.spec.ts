...
import scenarioData from '@data/bloque-1/E9-C-01.3.json';
import {
 acceptButtonFrom,
 goToComunesView,
 openUploadDialog,
...
test.describe('@bloque1 @E9-C-01.3 ', () => {
 test('@bloque1 @E9-C-01.3 @upload_valido debe cargar el archivo de Canales y mostrar la tabla con su estructura esperada', async ({
 page,
 }) => {
 ...
 await test.step('QA: abrir "Cargar Canales" y confirmar que "Aceptar" inicia deshabilitado', async () => {
 ...
 fixtureDir: 'fixtures/files/bloque-1/E9-C-01.3',
 ...
 await validateSuccessfulUpload(page, { entityName: 'Canales', closeWithAccept: true });
 });
