...
test.describe('@bloque1 @E36-C-03.5 ', () => {
 test('@bloque1 @E36-C-03.5 @editar debe bloquear la edicion de Configuracion de Parches con errores especificos por campo', async ({
 page,
 }) => {
