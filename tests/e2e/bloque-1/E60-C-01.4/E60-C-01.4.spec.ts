...
test.describe('@bloque1 @E60-C-01.4 ', () => {
 test('@bloque1 @E60-C-01.4 @columnas debe mantener solo las columnas por defecto en Maestro UoA al usar "Ocultar todas"', async ({
 page,
 }) => {
