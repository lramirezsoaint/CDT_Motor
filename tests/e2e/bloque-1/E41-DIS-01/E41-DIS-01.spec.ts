...
test.describe('@distribucion @critical @E41-DIS-01', () => {
  test('@critical @distribucion @E41-DIS-01 debe visualizar el progreso de una distribucion desde acciones', async ({
    distribucionPage,
  }) => {
