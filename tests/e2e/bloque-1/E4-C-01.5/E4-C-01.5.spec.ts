...
import scenarioData from '@data/bloque-1/E4-C-01.5.json';
import {
 acceptButtonFrom,
 goToComunesView,
 openUploadDialog,
...
test.describe('@bloque1 @E4-C-01.5 ', () => {
 test('@bloque1 @E4-C-01.5 @upload_valido debe aceptar un archivo valido de Maestro UoA y completar el flujo del modal', async ({
 page,
 }) => {
 ...
 fixtureDir: 'fixtures/files/bloque-1/E4-C-01.5',
 ...
 await validateSuccessfulUpload(page, { entityName: 'Maestro UoA', timeoutMs: 240_000 });
 });
 });
});
