...
test.describe('@bloque1 @E9-C-01.1 ', () => {
 test('@bloque1 @E9-C-01.1 @upload_valido debe cargar el archivo de Líneas y mostrar la tabla con su estructura esperada', async ({
 page,
 }) => {
