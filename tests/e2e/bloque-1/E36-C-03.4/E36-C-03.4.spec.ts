...
test.describe('@comunes @critical @E36-C-03.4', () => {
  test('@critical @comunes @E36-C-03.4 debe bloquear la edicion de Subcanales con errores especificos por campo', async ({
    page,
  }) => {
