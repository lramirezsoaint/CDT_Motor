...
test.describe('@bloque1 @E4-C-01.3.1 ', () => {
 test('@bloque1 @E4-C-01.3.1 @upload_valido debe permitir subir un nuevo archivo desde el flujo de Canales y mostrar todos los estados del modal', async ({
 page,
 }) => {
