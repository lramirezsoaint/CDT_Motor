...
test.describe('@comunes @critical @E60-C-02.2', () => {
  test('@critical @comunes @E60-C-02.2 debe filtrar columnas correctamente en Unidades de Cuenta - BBA/VFA desde el buscador del modal', async ({
    page,
  }) => {
