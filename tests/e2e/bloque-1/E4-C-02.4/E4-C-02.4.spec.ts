...
test.describe('@bloque1 @E4-C-02.4 ', () => {
 test('@bloque1 @E4-C-02.4 @upload_valido debe cargar el archivo de Subcanales cuando la aplicacion no tiene datos previos', async ({
 page,
 }) => {
