...
test.describe('@bloque1 @E35-C-03.5 ', () => {
 test('@bloque1 @E35-C-03.5 @registrar debe bloquear el alta de Configuración de Parches con errores específicos por campo', async ({ page }) => {
