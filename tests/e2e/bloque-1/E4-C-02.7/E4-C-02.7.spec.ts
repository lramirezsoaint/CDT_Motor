...
test.describe('@comunes @critical @E4-C-02.7', () => {
  test('@critical @comunes @E4-C-02.7 debe cargar el archivo de Configuracion de Parches cuando la aplicacion no tiene datos previos', async ({
    page,
  }) => {
