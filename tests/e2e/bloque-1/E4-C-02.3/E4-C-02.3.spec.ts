...
test.describe('@bloque1 @E4-C-02.3 ', () => {
 test('@bloque1 @E4-C-02.3 @upload_valido debe cargar el archivo de Canales cuando la aplicacion no tiene datos previos', async ({
 page,
 }) => {
