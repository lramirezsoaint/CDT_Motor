...
test.describe('@comunes @critical @E60-C-02.1', () => {
  test('@critical @comunes @E60-C-02.1 debe agregar y quitar columnas opcionales en Unidades de Cuenta - BBA/VFA reflejandolo en tabla', async ({
    page,
  }) => {
