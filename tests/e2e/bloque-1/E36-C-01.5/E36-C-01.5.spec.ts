...
test.describe('@bloque1 @E36-C-01.5 ', () => {
 test('@bloque1 @E36-C-01.5 @editar debe editar Configuración de Parches con porcentaje válido y bloquear uno inválido', async ({
 page,
 }) => {
