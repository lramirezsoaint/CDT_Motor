...
test.describe('@comunes @critical @E35-C-03.2', () => {
  test('@critical @comunes @E35-C-03.2 debe bloquear el alta de Grupo Producto con errores específicos por campo', async ({ page }) => {
