...
test.describe('@distribucion @critical @E43-DIS-01', () => {
  test('@critical @distribucion @E43-DIS-01 debe exigir confirmaciones antes de eliminar una distribucion creada', async ({
    distribucionPage,
    page,
  }) => {
    if (!deleteTargetName) {
