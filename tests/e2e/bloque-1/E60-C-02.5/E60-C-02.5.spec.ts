...
test.describe('@bloque1 @E60-C-02.5 ', () => {
 test('@bloque1 @E60-C-02.5 @columnas debe mostrar automaticamente las columnas por defecto en Unidades de Cuenta - BBA/VFA', async ({
 page,
 }) => {
