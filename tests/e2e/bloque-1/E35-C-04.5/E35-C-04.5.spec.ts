...
test.describe('@comunes @critical @E35-C-04.5', () => {
  test('@critical @comunes @E35-C-04.5 debe sobrescribir Configuración de Parches manual al cargar el archivo del periodo', async ({
    page,
  }) => {
