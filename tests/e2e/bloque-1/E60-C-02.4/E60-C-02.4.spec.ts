...
test.describe('@bloque1 @E60-C-02.4 ', () => {
 test('@bloque1 @E60-C-02.4 @columnas debe mantener solo las columnas por defecto en Unidades de Cuenta - BBA/VFA al usar "Ocultar todas"', async ({
 page,
 }) => {
