...
test.describe('@comunes @critical @E35-C-04.4', () => {
  test('@critical @comunes @E35-C-04.4 debe sobrescribir un Subcanal manual al cargar el archivo del periodo', async ({ page }) => {
