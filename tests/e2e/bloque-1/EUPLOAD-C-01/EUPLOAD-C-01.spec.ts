...
test.describe('@bloque1 @EUPLOAD-C-01 estados de carga de archivos', () => {
 test('@bloque1 @EUPLOAD-C-01.1 @editar sin data carga archivo sin advertencia y actualiza tabla', async ({ page }) => {
 ...
 test('@bloque1 @EUPLOAD-C-01.2 @upload_valido con data muestra advertencia y reemplaza sin duplicar', async ({ page }) => {
 ...
 test('@bloque1 @EUPLOAD-C-01.3 @upload_invalido archivo inválido muestra error y no cambia tabla', async ({ page }) => {
 await openHarness(page, { hasData: true, tableRows: [['LIN001', 'Línea cargada']] });
