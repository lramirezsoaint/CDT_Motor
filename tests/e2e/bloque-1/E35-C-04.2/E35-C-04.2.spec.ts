...
test.describe('@comunes @critical @E35-C-04.2', () => {
  test('@critical @comunes @E35-C-04.2 debe sobrescribir Grupo Producto manual al cargar el archivo del periodo', async ({
    page,
  }) => {
