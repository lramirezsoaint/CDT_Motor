...
test.describe('@comunes @critical @E35-C-04.1', () => {
  test('@critical @comunes @E35-C-04.1 debe sobrescribir una Línea manual al cargar el archivo del periodo', async ({ page }) => {
