...
test.describe('@comunes @critical @E4-C-02.1', () => {
  test('@critical @comunes @E4-C-02.1 debe cargar el archivo de Lineas cuando la aplicacion no tiene datos previos', async ({
    page,
  }) => {
