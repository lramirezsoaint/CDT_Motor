...
- **Antes de implementar cualquier caso**, verificar que el ID exista en `docs/catalogos/` y que no esté duplicado o en bloques no ejecutados.
- **Cada caso implementado debe actualizar `docs/seguimiento/seguimiento_casos_prueba.md`** para reflejar si está listo para automatización, pendiente de datos o bloqueado por defecto.
...
- [ ] Se actualizó `docs/seguimiento/seguimiento_casos_prueba.md` con el estado del caso.
