...
| E64-GF-ER-01-01 | E64-GF | No | implemented | conditionally_automatable | pending | assigned | Falta validar en ambiente la evidencia exacta de ejecución de fases y cierre más allá de las señales visibles actuales. | Se creó cobertura inicial en `tests/e2e/procesos/gastos-financieros.critical.spec.ts` y un Page Object específico para `Procesos > Gastos Financieros`. |
