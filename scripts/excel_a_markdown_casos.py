...
DEFAULT_JSON_OUTPUT = "data/catalogos-json/catalogo_casos_prueba.json"
DEFAULT_MARKDOWN_OUTPUT = "docs/catalogos/catalogo_casos_prueba.md"
DEFAULT_PREFIX_REPORT = "docs/reportes/reporte_asociacion_por_prefijo.md"
