...
const workbook = xlsx.readFile(path.join(process.cwd(), 'source-material', 'excel', '2025-PACIFICO-DESARORROLLO-Casos de Prueba-FASE 2- bloque 2.xlsx'));
...
fs.writeFileSync(path.join(process.cwd(), 'docs', 'catalogs', 'catalogo_casos_prueba_bloque2.md'), out, 'utf8');
fs.writeFileSync(path.join(process.cwd(), 'docs', 'catalogs', 'catalogo_casos_prueba_bloque2.json'), JSON.stringify({ scenarios: [...scenarioMap.values()], cases }, null, 2), 'utf8');
console.log('Generated docs/catalogs/catalogo_casos_prueba_bloque2.md and JSON with', grouped.size, 'scenarios and', cases.length, 'cases');
